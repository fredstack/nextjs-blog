  ...
  const posts = [
    {
      ...
      content:
        "Next.js is a powerful React framework that allows you to build fast, server-rendered applications...",
    ...
    },
    {
      ...
      content:
        "Static Site Generation (SSG) is one of the key features of Next.js...",
      date: new Date("2024-08-23T10:30:00Z"),
    },
    {
      ...
      content:
        "In this post, we will guide you through the process of deploying a Next.js application...",
      date: new Date("2024-08-23T10:30:00Z"),
    },
  ];
